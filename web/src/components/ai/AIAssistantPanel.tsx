  ...
  return (
    <div className="ae-ai-panel rounded-2xl border border-[#f2d894]/[0.22] bg-gradient-to-br from-[#141d2b]/[0.94] via-[#0b1220]/[0.90] to-[#07090d]/[0.94] backdrop-blur-xl p-4 shadow-[0_16px_35px_rgba(0,0,0,0.55)]">
      ...
      <div className="space-y-4">
        ...
        {loading && (
          <div className="rounded-2xl border border-[#f2d894]/[0.12] bg-[#0d141f]/[0.70] p-4 text-center">
              ...
              <>
                ...
                {suggestions.nextSteps && suggestions.nextSteps.length > 0 && (
                  <div className="rounded-2xl border border-[#f2d894]/[0.24] bg-[#d6b56d]/[0.10] p-4">
                    <p className="text-xs font-semibold text-[#f2d894] mb-2">Next Steps:</p>
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center gap-2 text-xs">
                          <span className={`inline-flex items-center rounded-full px-2 py-0.5 font-medium ${
                            task.category === 'contract' ? 'bg-[#d6b56d]/[0.14] text-[#f2d894]' :
                            task.category === 'marketing' ? 'bg-pink-500/20 text-pink-200' :
                            'bg-[#d6b56d]/[0.14] text-[#f2d894]'
                          }`}>
      ...
      <div className="mt-4 pt-4 border-t border-white/10">
        <p className="text-[10px] text-slate-500 text-center">
          <Lightbulb className="mr-1 inline h-3 w-3" /> AgentEasePro AI focuses on Utah real estate workflows and your app features only
        </p>
      </div>
    </div>
  );
