...
export function ContractsAIAssistant({
  ...
  if (minimized) {
    return (
      <button
        ...
        className="fixed bottom-6 right-6 z-50 flex items-center gap-2 px-4 py-3 rounded-full bg-gradient-to-r from-[#f2d894] to-[#9f7933] text-[#171106] shadow-2xl shadow-[#d6b56d]/[0.24] hover:scale-105 transition-transform"
      >
  ...
  return (
    <div className="ae-ai-panel flex flex-col h-full max-h-[600px] rounded-3xl border border-[#f2d894]/[0.18] bg-gradient-to-br from-[#141d2b]/[0.96] via-[#0b1220]/[0.94] to-[#07090d]/[0.96] backdrop-blur-xl shadow-2xl overflow-hidden">
      {/* Header */}
      <div className="flex items-center justify-between px-5 py-4 border-b border-[#f2d894]/[0.12] bg-gradient-to-r from-[#d6b56d]/[0.12] to-white/[0.03]">
        <div className="flex items-center gap-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-[#f2d894] to-[#9f7933] text-[#171106] shadow-lg shadow-[#d6b56d]/[0.20]">
            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
            </svg>
          </div>
        ...
        {messages.length === 0 ? (
          <div className="space-y-6">
            ...
            <div className="text-center py-4">
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-[#d6b56d]/[0.16] to-white/[0.04] mb-4">
                <svg className="w-8 h-8 text-[#f2d894]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div className="grid grid-cols-2 gap-2">
                {quickActions.map((action) => (
                  <button
                    ...
                    className="flex items-center gap-2 px-3 py-2.5 rounded-xl bg-white/5 border border-white/10 text-left hover:bg-[#d6b56d]/[0.10] hover:border-[#f2d894]/[0.28] transition-all group"
                  >
                    <span className="text-slate-400 group-hover:text-[#f2d894] transition-colors">{action.icon}</span>
                ...
                <div className="space-y-1">
                  {getSuggestions().map((suggestion, i) => (
                    <button
                      ...
                      className="w-full flex items-center gap-2 px-3 py-2 rounded-xl text-left hover:bg-[#d6b56d]/[0.10] transition-colors group"
                    >
                      <svg className="w-4 h-4 text-[#f2d894]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              >
                <div
                  className={`max-w-[85%] rounded-2xl px-4 py-3 ${
                    message.role === 'user'
                      ? 'bg-gradient-to-r from-[#f2d894] to-[#9f7933] text-[#171106]'
                    ...
                    <div className="flex flex-wrap gap-2 mt-3 pt-3 border-t border-white/10">
                      {message.actions.map((action, i) => (
                        <button
                          ...
                          className="px-3 py-1.5 rounded-lg bg-[#d6b56d]/[0.14] text-xs font-medium text-[#f2d894] hover:bg-[#d6b56d]/[0.22] transition-colors"
                        >
                          {action.label}
                        </button>
                      ))}
                ...
                <div className="bg-white/10 rounded-2xl px-4 py-3">
                  <div className="flex items-center gap-2">
                    <div className="flex space-x-1">
                      <div className="w-2 h-2 rounded-full bg-[#f2d894] animate-bounce" style={{ animationDelay: '0ms' }} />
                      <div className="w-2 h-2 rounded-full bg-[#f2d894] animate-bounce" style={{ animationDelay: '150ms' }} />
                      <div className="w-2 h-2 rounded-full bg-[#f2d894] animate-bounce" style={{ animationDelay: '300ms' }} />
                    </div>
      ...
      {isListening && (
        <div className="px-4 py-2 bg-[#d6b56d]/[0.10] border-t border-[#f2d894]/[0.20] flex items-center gap-2">
          <div className="flex space-x-1">
            <div className="w-1.5 h-3 bg-[#f2d894] rounded-full animate-pulse" />
            <div className="w-1.5 h-4 bg-[#f2d894] rounded-full animate-pulse" style={{ animationDelay: '100ms' }} />
            <div className="w-1.5 h-2 bg-[#f2d894] rounded-full animate-pulse" style={{ animationDelay: '200ms' }} />
            <div className="w-1.5 h-5 bg-[#f2d894] rounded-full animate-pulse" style={{ animationDelay: '300ms' }} />
            <div className="w-1.5 h-3 bg-[#f2d894] rounded-full animate-pulse" style={{ animationDelay: '400ms' }} />
          </div>
          <span className="text-xs text-[#f2d894]">Listening... speak your question</span>
        </div>
      )}
      ...
      <div className="p-4 border-t border-white/10 bg-slate-900/50">
        <div className="flex items-center gap-2">
          <div className="flex-1 relative">
            <input
              ...
              className="w-full rounded-xl border border-[#f2d894]/[0.12] bg-white/5 px-4 py-3 pr-12 text-sm text-white placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-[#d6b56d]/[0.45] focus:border-[#f2d894]/[0.45]"
              disabled={loading}
            />
              ...
              <button
                ...
                className={`absolute right-2 top-1/2 -translate-y-1/2 p-2 rounded-lg transition-colors ${
                  isListening
                    ...
                    : 'text-slate-400 hover:text-[#f2d894] hover:bg-[#d6b56d]/[0.10]'
                }`}
              >
                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 11a7 7 0 01-7 7m0 0a7 7 0 01-7-7m7 7v4m0 0H8m4 0h4m-4-8a3 3 0 01-3-3V5a3 3 0 116 0v6a3 3 0 01-3 3z" />
        ...
        <p className="mt-2 text-[10px] text-slate-500 text-center">
          <Lightbulb className="mr-1 inline h-3 w-3" /> AI is trained on Utah real estate practices • Not legal advice
        </p>
      </div>
    </div>
  );
