...
import { Copy, Home, Lightbulb, Sparkles, Zap } from 'lucide-react';
    ...
    return (
      <div className="rounded-2xl border border-emerald-500/25 bg-gradient-to-br from-emerald-500/8 via-teal-500/5 to-transparent backdrop-blur-xl p-4 shadow-[0_16px_35px_rgba(0,0,0,0.55)]">
        ...
        <p className="text-[10px] text-slate-500 text-center mt-3">
          <Lightbulb className="mr-1 inline h-3 w-3" /> AI crafted for Utah real estate listings
        </p>
      </div>
    );
  }
    ...
    <div className="rounded-2xl border border-emerald-500/25 bg-gradient-to-br from-emerald-500/8 via-teal-500/5 to-transparent backdrop-blur-xl p-4 shadow-[0_16px_35px_rgba(0,0,0,0.55)]">
          ...
          {descriptions.highlights && descriptions.highlights.length > 0 && (
            <div className="rounded-2xl border border-white/10 bg-slate-900/50 p-4">
              <h4 className="text-xs font-bold uppercase tracking-wide text-slate-400 mb-3">
                <Sparkles className="mr-1 inline h-3.5 w-3.5" /> Key Highlights
              </h4>
      ...
      <div className="mt-4 pt-4 border-t border-white/10">
        <p className="text-[10px] text-slate-500 text-center">
          <Lightbulb className="mr-1 inline h-3 w-3" /> Always review and edit AI-generated content before publishing
        </p>
      </div>
    </div>
  );
