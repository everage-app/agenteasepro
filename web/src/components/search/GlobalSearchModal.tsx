            ...
            {query.length < 2 ? (
              ...
              <div className="py-2">
                ...
                {results.deals.length > 0 && (
                  <ResultGroup label="Deals" icon={FileText}>
                ...
                {results.clients.length > 0 && (
                  <ResultGroup label="Clients" icon={UserRound}>
                ...
                {results.leads.length > 0 && (
                  <ResultGroup label="Leads" icon={Target}>
...
function ResultGroup({ label, icon: Icon, children }: { label: string; icon: LucideIcon; children: React.ReactNode }) {
  return (
    <div>
