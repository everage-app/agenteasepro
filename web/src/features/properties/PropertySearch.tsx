...
import { ClipboardList, Globe2, Home as HomeIcon, KeyRound, MapPin, Mountain, Search as SearchIcon, Sparkles } from 'lucide-react';
  ...
  return (
    <div className="space-y-2">
      <div className="flex items-center gap-2 text-xs font-medium text-slate-500 dark:text-slate-400">
        <Globe2 className="h-3.5 w-3.5" /> Search on portals
      </div>
      ...
      <div className="flex flex-wrap gap-2 pt-1">
        ...
        {assessorLink && (
          <a
            ...
            className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs font-semibold border transition-all hover:scale-105 bg-slate-100 dark:bg-slate-500/15 text-slate-600 dark:text-slate-400 border-slate-200 dark:border-slate-500/30"
          >
            <ClipboardList className="h-3.5 w-3.5" /> County Records
            <Icons.ExternalLink />
          </a>
        )}
      </div>
