...
import { FileText, Home, Sparkles, UserRound, Zap } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <Card className="bg-white/95 dark:bg-gradient-to-br dark:from-purple-500/10 dark:to-blue-500/10 border-slate-200/70 dark:border-purple-400/30 p-6 shadow-[0_12px_30px_rgba(15,23,42,0.08)]">
        <div className="flex items-start gap-4">
          <Zap className="h-8 w-8 text-purple-500 dark:text-purple-200" />
          <div>
      ...
      {/* Automation sections */}
      {automationSections.map((section: { title: string; description: string; icon: LucideIcon; color: string; rules: AutomationRule[] }) => {
        ...
        <Card key={section.title} className="p-6 bg-white/95 dark:bg-slate-950/60 border border-slate-200/70 dark:border-white/10">
          <div className="flex items-start gap-4 mb-4">
            <div className={`flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br ${section.color} border text-white`}>
      ...
      {rules.length === 0 && (
        <Card className="text-center py-12 bg-white/95 dark:bg-slate-950/60 border border-slate-200/70 dark:border-white/10">
          <Zap className="mx-auto mb-4 h-10 w-10 text-purple-300" />
