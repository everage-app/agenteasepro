...
import { AlertTriangle, Globe2, Loader2, Mail, Megaphone, MessageSquare, Rocket, Sparkles, X, type LucideIcon } from 'lucide-react';
...
const channelOptions: ChannelOption[] = [
  { key: 'EMAIL', label: 'Email', description: 'Weekly nurture tips and updates', icon: Mail },
  { key: 'SMS', label: 'Text', description: 'Quick nudges and check-ins', icon: MessageSquare },
  { key: 'SOCIAL', label: 'Social', description: 'Engage via social reminders', icon: Megaphone },
  { key: 'WEBSITE', label: 'Website', description: 'Landing page touchpoints', icon: Globe2 },
];
                  ...
                  <div className="space-y-2">
                    {channelOptions.map((option) => {
                      ...
                      return (
                        ...
                        >
                          <ChannelIcon className="h-5 w-5 flex-shrink-0" />
                          <div>
