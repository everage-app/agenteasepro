        ...
        return (
          <div className="space-y-4">
            ...
            <div>
              ...
              />
              <p className="text-xs text-slate-400 mt-2">Used for replies and personalization on listing blasts.</p>
              <p className="text-xs text-slate-500 mt-1">
                Replies go here. SendGrid uses the verified AgentEase sender unless this email domain is approved.
              </p>
            </div>
          </div>
        );
