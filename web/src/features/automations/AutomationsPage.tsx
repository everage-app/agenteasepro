...
import { Bot, FileText, Home, Mail, Settings, Sparkles, UserRound, X, Zap } from 'lucide-react';
...
const EVENT_TYPE_LABELS: Record<string, { label: string; color: string; icon: LucideIcon }> = {
  LISTING_CREATED: {
      ...
      <div className="space-y-6">
            ...
            {playbooks.map((playbook) => {
              ...
              <div key={playbook.key} className="rounded-2xl border border-slate-200/70 dark:border-white/10 bg-white/90 dark:bg-white/5 p-4">
                <div className="flex items-start gap-3">
                  <div className="flex h-10 w-10 items-center justify-center rounded-2xl border border-slate-200/70 bg-white text-slate-700 dark:border-white/10 dark:bg-slate-900/70 dark:text-[#f2d894]">
        ...
        {rules.length === 0 && (
          <Card className="text-center py-12">
            <Zap className="mx-auto mb-4 h-10 w-10 text-blue-300" />
          ...
          <div className="space-y-6">
                ...
                <div key={eventType}>
                  ...
                  <div className="flex flex-wrap items-center justify-between gap-3 mb-4">
                    <div className="flex items-center gap-3">
                      <div
                        className={`flex h-12 w-12 items-center justify-center rounded-2xl bg-gradient-to-br ${eventConfig.color} border`}
                      >
            ...
            <Card className="bg-gradient-to-br from-purple-500/10 to-blue-500/10 border-purple-400/30 p-6">
              <div className="flex items-start gap-4">
                <div className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-xl bg-purple-500/20 text-purple-200">
                  ...
                  <div>
                    <div className="px-6 pt-6 pb-4 border-b border-slate-200/60 dark:border-white/10 bg-gradient-to-br from-slate-50/70 via-white/90 to-slate-50/70 dark:from-slate-950/80 dark:via-slate-950/95 dark:to-slate-900/80">
                      <div className="flex items-start justify-between gap-4">
                        <div className="flex items-start gap-4">
                          <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-emerald-500/10 dark:bg-emerald-500/20 border border-emerald-500/20 text-emerald-600 dark:text-emerald-200">
                            <PlaybookIcon className="h-5 w-5" />
                          </div>
                          <div>
