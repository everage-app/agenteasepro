...
export function PriorityActionCenter() {
  ...
  if (loading) {
    return (
      <div className="rounded-[32px] border border-white/10 bg-gradient-to-br from-slate-950/80 to-[#101525]/80 backdrop-blur-xl flex justify-center items-center h-64">
        <div className="text-slate-400 text-sm animate-pulse">Loading priority actions...</div>
      </div>
    );
  }

  return (
    <div className="rounded-[32px] border border-white/10 bg-gradient-to-br from-slate-950/80 to-[#101525]/80 backdrop-blur-xl shadow-2xl overflow-hidden h-full flex flex-col relative">
      ...
      <div className="border-b border-white/10 px-6 py-4 relative z-10">
      ...
      <div className="divide-y divide-white/5">
        {actions.length === 0 ? (
          <div className="px-6 py-8 text-center">
            <Target className="mx-auto mb-2 h-8 w-8 text-cyan-300" />
      ...
      {smartFollowUps.length > 0 && (
        <>
          <div className="border-t border-white/10 px-6 py-3">
            <div className="flex items-center gap-2">
              <span className="inline-flex items-center gap-1 text-[10px] uppercase tracking-[0.16em] text-cyan-400 font-semibold"><Brain className="h-3 w-3" /> Smart Follow-ups</span>
