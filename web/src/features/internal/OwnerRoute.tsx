      ...
      <div className="min-h-screen flex items-center justify-center">
        <div className="rounded-2xl border border-white/10 bg-slate-950/60 backdrop-blur-xl px-6 py-5">
          <div className="flex items-center gap-3">
            ...
            <div className="text-sm text-slate-200 font-semibold">Verifying internal access…</div>
          </div>
          <div className="mt-1 text-xs text-slate-400">This portal is private and limited to approved internal staff.</div>
        </div>
      </div>
    );
  }
      ...
      <div className="min-h-screen flex items-center justify-center px-4">
        <div className="max-w-md w-full rounded-[28px] border border-white/10 bg-slate-950/70 backdrop-blur-2xl p-6">
          ...
          <div className="mt-2 text-sm text-slate-400">
            Set <span className="text-slate-200 font-semibold">AGENTEASE_OWNER_EMAIL</span>, <span className="text-slate-200 font-semibold">AGENTEASE_OWNER_ADMIN_EMAILS</span>, or an active internal staff role, then reload.
          </div>
          <div className="mt-4 text-xs text-slate-500">You’re signed in, but internal access can’t be verified yet.</div>
        </div>
      </div>
    );
  }
