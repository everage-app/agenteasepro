...
const DEFAULT_OWNER_EMAIL = 'brysen@agenteasepro.com';
...
export function InternalLoginPage() {
  ...
  const [email, setEmail] = useState(() => getOwnerEmail());
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <div className="mt-2 text-[11px] text-slate-500">
                Use the master owner email or an approved owner-admin email.
              </div>
            </div>
