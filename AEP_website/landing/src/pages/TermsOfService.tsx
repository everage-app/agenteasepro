          ...
          <div className="glass-card rounded-3xl p-8 md:p-12">
            ...
            <div className="prose prose-invert prose-slate max-w-none">
              ...
              <section className="mb-10">
                ...
                <p className="text-slate-300 leading-relaxed">
                  We may offer a free trial period, currently a 7-day full-access trial for the standard plan unless another offer is shown at signup or checkout. At the end of the trial, continued access requires an active paid subscription unless you cancel before the trial ends.
                </p>
              </section>
