  ...
  const features = [
    {
      ...
      title: 'Stunning Listing Sites',
      description: 'Auto-generate beautiful, high-converting property websites. Share them instantly to social media to capture warm buyer leads directly into your CRM.',
      gradient: 'from-[#f4b860] to-amber-500',
      bgGlow: 'from-[#f4b860]/20 to-amber-500/20',
      stat: '5 min',
      statLabel: 'site launch',
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      title: 'Live IDX Search & Analytics',
      description: 'Plug directly into UtahRealEstate to provide buyers a Zillow-level search experience. See exactly which properties your clients are viewing and favoriting.',
      gradient: 'from-amber-400 to-yellow-400',
      bgGlow: 'from-amber-400/20 to-yellow-400/20',
      stat: '100%',
      statLabel: 'MLS Data Feed',
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      title: 'Smart Utah REPCs',
      description: 'Draft a compliant Utah REPC with smart-fill MLS data. Never miss a deadline with automated calendar reminders and tracker alerts.',
      gradient: 'from-[#f4b860] to-amber-500',
      bgGlow: 'from-[#f4b860]/20 to-amber-500/20',
      stat: '0',
    ...
    },
    {
      ...
      description: 'Route leads from Facebook, Google, and your website into one inbox. Instantly follow up via connected Email and 2-way SMS texting.',
    ...
    },
    {
      ...
      description: 'Stop paying limits for DocuSign. Send offers, disclosures, and addenda directly to clients for secure, legally binding signatures on any device.',
      gradient: 'from-slate-400 to-slate-500',
      bgGlow: 'from-slate-400/20 to-slate-500/20',
      stat: 'Real-time',
      statLabel: 'bound signatures',
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <section id="features" className="relative py-20 md:py-32 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 relative z-10">
        ...
        <div className="mt-16 text-center">
          ...
          <p className="mt-4 text-sm text-slate-500">No card to create an account • Setup in under 5 minutes</p>
        </div>
      </div>
    </section>
  );
