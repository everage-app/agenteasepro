  ...
  return (
    <section className="relative py-12 md:py-16 overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 md:px-6 relative z-10">
        <div className="relative rounded-3xl p-7 md:p-9 bg-gradient-to-br from-slate-900/80 to-slate-800/40 border border-[#f4b860]/20 backdrop-blur-xl overflow-hidden"
          ...
          <div className="relative z-10 grid md:grid-cols-5 gap-6 items-center">
            ...
            <div className="md:col-span-3">
              ...
              <p className="text-slate-400 leading-relaxed text-sm md:text-base">
                Download the free <span className="text-white font-medium">47-point closing checklist</span> used by top Utah agents,
                plus practical weekly tips to close more deals.
              </p>
            </div>
            ...
            <div className="md:col-span-2">
              {submitted ? (
                <div className="text-center p-5 rounded-2xl bg-[#f4b860]/10 border border-[#f4b860]/20">
                ...
                >
                  ...
                  <button
                    type="submit"
                    disabled={submitting}
                    className="w-full py-3 rounded-xl font-semibold text-slate-900 bg-gradient-to-r from-[#f4b860] to-amber-400 hover:from-[#f5c87a] hover:to-amber-300 shadow-lg shadow-[#f4b860]/25 transition-all duration-300 hover:scale-[1.02] disabled:opacity-60 disabled:cursor-not-allowed"
                  >
